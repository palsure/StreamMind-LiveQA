...
\begin{enumerate}[leftmargin=*,itemsep=2pt]
    ...
    Non-neural components run in under 1\,ms; on a T4 GPU the average per-query latency is 3.5\,s.
\end{enumerate}
...
Instant questions (74.1\%) are easiest because a single frame suffices---even baselines exceed 40\%.
Historical questions (50.0\%) benefit from the SKM's importance-based retention, showing the largest margin over baselines ($+$22.2 points vs.\ Dispider).
