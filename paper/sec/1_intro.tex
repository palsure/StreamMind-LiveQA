...
We introduce \emph{LiveQA-Bench}, 550+ temporally-diverse questions spread across 12 video streams covering diverse visual domains (cooking, traffic, gym, surveillance, and more), with explicit scope labels inspired by the per-type evaluation in NExT-QA~\cite{xiao2021nextqa}.
